...
/* Paso resultado de la funci ón a r1, cadena a
	...
	mov r1, r0							@Transfiere datos entre celdas de memoria
	ldr r0, = var1
	bl printf

/* Segunda llamada, esta vez poly3 (1, -1, 1, -1, 8) */

	mov r0, # 1						        @Transfiere datos entre celdas de memoria
	mov r1, # -1							@Transfiere datos entre celdas de memoria
	mov r2, # 1							@Transfiere datos entre celdas de memoria
	mov r3, # -1							@Transfiere datos entre celdas de memoria
	mov r4, # 8							@Transfiere datos entre celdas de memoria
	push { r4 }
	bl poly3
	add sp, # 4
...
/* Llamo e imprimo poly3 (2, 0, 0, 0, 8) */
	...
	mov r0, # 2							@Transfiere datos entre celdas de memoria
	mov r1, # 0                                                     @Transfiere datos entre celdas de memoria
	mov r2, # 0							@Transfiere datos entre celdas de memoria
	mov r3, # 0							@Transfiere datos entre celdas de memoria
	mov r4, # 8							@Transfiere datos entre celdas de memoria
	push { r4 }
	bl poly3
	add sp, # 4
